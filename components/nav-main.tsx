                      ...
                      <SidebarMenuSubItem key={session.session_id} className="group/session relative">
                        {isEditing ? (
                          ...
                          <>
                            ...
                            <DropdownMenu>
                              <DropdownMenuTrigger asChild>
                                <button className="absolute right-0 top-1/2 -translate-y-1/2 opacity-0 group-hover/session:opacity-100 data-[state=open]:opacity-100 p-1.5 hover:bg-accent rounded z-10">
